...
public final class FragmentVariables {
    ...
    public static final class ProductFragments {
        ...
        public static final String EDIT_PRODUCT_FRAGMENT = "EDIT_PRODUCT_FRAG";
    }

    public static final class OrderFragments {
    ...
    public static final class GeneralFragments {
    ...
    public static final class ProfileFragments {
        public static final String PROFILE_FRAG_TAG = "PROFILE_FRAG";
        public static final String EDIT_PROFILE_FRAG_TAG = "EDIT_PROFILE_FRAG";
    }
