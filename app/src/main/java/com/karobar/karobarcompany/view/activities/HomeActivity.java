    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.nav_menu_order_list: {
                IntentUtils.getInstance(this).moveToNextActivity(this, OrderActivity.class, null);
            }
            break;
            case R.id.nav_menu_product_list: {
                IntentUtils.getInstance(this).moveToNextActivity(this, ProductActivity.class, null);
            }
            break;
        }
        return true;
